...
class ViewController1: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate, NSURLConnectionDelegate, NSURLConnectionDataDelegate, UIPopoverPresentationControllerDelegate{
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        self.foodCartsL0 = [foodCart]()
        self.foodCartsL1 = [foodCart]()
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "lookUp" {
            if let DestVC = segue.destinationViewController as? LookUpViewController{
        ...
        else if segue.identifier == "an1"
        {
            //set key to fetch corresponging json file from server
            print("an1 segue")
            if let DestVC1 = segue.destinationViewController as? Location1TableViewController{
                DestVC1.foodCartsL1 = self.foodCartsL1
            }
            else {
                print("ERROR")
            }
